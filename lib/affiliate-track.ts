...
type AffiliateEventParams = {
  merchant: string;
  /** Placering: fx guide-picks, home-search, search-curated-wine, search-dsf-curated, guide-inline-search, partner-leaderboard-{hub}, home-featured-store-*, product-feed-preview. */
  placement: string;
  slug?: string;
  hub?: string;
  url?: string;
