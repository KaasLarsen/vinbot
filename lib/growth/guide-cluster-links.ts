...
const HEDVIN_PORT: GuideClusterLink[] = [
  ...
  { slug: "hvid-portvin", label: "Hvid portvin" },
  { slug: "hvad-er-colheita", label: "Hvad er Colheita?" },
  { slug: "lbv-ufiltreret-vs-filtreret", label: "LBV ufiltreret vs. filtreret" },
  { slug: "vintage-portvin-dekantering", label: "Vintage Port dekantering" },
  { slug: "douro-dalen-subregioner", label: "Douro-subregioner" },
  ...
  { slug: "portvin-til-risalamande", label: "Portvin til risalamande" },
];
...
export const GUIDE_CLUSTER_LINKS: Record<string, GuideClusterBlock | GuideClusterBlock[]> = {
  ...
  "vin-som-naturlig-smagsforstaerker": videnBlock(
    ["vin-som-naturlig-smagsforstaerker"],
    "Vin som smagsforstærker",
    "Alkohol og syre som naturlige smagsfremmere i gryden.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "vinost-pantry-5-flasker", label: "Vinøst pantry" },
      { slug: "kemien-i-marinering-med-vin", label: "Kemien i marinering" },
      { slug: "sadan-bruger-du-vin-til-sauce-og-simren", label: "Vin til sauce" },
      { slug: "umami-uden-koed-vin", label: "Umami uden kød" },
      { slug: "hvilken-vin-til-madlavning-sovs", label: "Vin til madlavning" },
    ],
  ),
  "vinost-pantry-5-flasker": videnBlock(
    ["vinost-pantry-5-flasker"],
    "Vinøst pantry",
    "Fem flasker der erstatter færdigkøbte poser og flasker.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "vin-som-naturlig-smagsforstaerker", label: "Vin som smagsforstærker" },
      { slug: "byg-din-egen-eddikemor", label: "Eddikemor" },
      { slug: "naturlig-konservering-med-vin-og-eddike", label: "Konservering" },
      { slug: "hvilken-vin-til-madlavning-sovs", label: "Vin til madlavning" },
      { slug: "sadan-bruger-du-vin-til-sauce-og-simren", label: "Sauce og simren" },
    ],
  ),
  "kemien-i-marinering-med-vin": videnBlock(
    ["kemien-i-marinering-med-vin"],
    "Kemien i marinering",
    "Syre, tid og vinvalg — uden kemiske mørnere.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "vin-som-naturlig-smagsforstaerker", label: "Smagsforstærker" },
      { slug: "vinost-pantry-5-flasker", label: "Vinøst pantry" },
      { slug: "naturlig-konservering-med-vin-og-eddike", label: "Konservering" },
      { slug: "sadan-bruger-du-vin-til-sauce-og-simren", label: "Sauce og simren" },
    ],
  ),
  "naturlig-konservering-med-vin-og-eddike": videnBlock(
    ["naturlig-konservering-med-vin-og-eddike"],
    "Konservering med vin og eddike",
    "Alkohol og syre som klassiske holdbarheds-værktøjer.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "byg-din-egen-eddikemor", label: "Eddikemor" },
      { slug: "vinost-pantry-5-flasker", label: "Vinøst pantry" },
      { slug: "kemien-i-marinering-med-vin", label: "Marinering" },
      { slug: "hvor-laenge-holder-aabnet-vin", label: "Åbnet vin" },
      { slug: "vin-tiktok-trends-spicy-sauvy-og-vineddike", label: "TikTok-vineddike" },
    ],
  ),
  "byg-din-egen-eddikemor": videnBlock(
    ["byg-din-egen-eddikemor"],
    "Byg din egen eddikemor",
    "Restvin til levende gourmet-vineddike — fuld metode.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "naturlig-konservering-med-vin-og-eddike", label: "Konservering" },
      { slug: "vinost-pantry-5-flasker", label: "Vinøst pantry" },
  ...
  "ruby-portvin": hedvinBlock(
    ["ruby-portvin"],
    "Portvin-klyngen",
    "Ruby i kontekst — tawny, LBV, white og købsguiden.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "ruby-portvin").slice(0, 8),
  ),
  "tawny-portvin": hedvinBlock(
    ["tawny-portvin"],
    "Portvin-klyngen",
    "Tawny i kontekst — Colheita, ost, chokolade og køb.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "tawny-portvin").slice(0, 8),
  ),
  "hvid-portvin": hedvinBlock(
    ["hvid-portvin"],
    "Portvin-klyngen",
    "White port og Port & Tonic — plus typer, servering og køb.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "hvid-portvin").slice(0, 8),
  ),
  "hvad-er-colheita": hedvinBlock(
    ["hvad-er-colheita"],
    "Portvin-klyngen",
    "Colheita som årgangs-tawny — se også aged tawny og Vintage.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "hvad-er-colheita").slice(0, 8),
  ),
  "lbv-ufiltreret-vs-filtreret": hedvinBlock(
    ["lbv-ufiltreret-vs-filtreret"],
    "Portvin-klyngen",
    "LBV filtered vs. unfiltered — plus Vintage-dekantering og køb.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "lbv-ufiltreret-vs-filtreret").slice(0, 8),
  ),
  "vintage-portvin-dekantering": hedvinBlock(
    ["vintage-portvin-dekantering"],
    "Portvin-klyngen",
    "Vintage-dekantering i kontekst — LBV, servering og holdbarhed.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "vintage-portvin-dekantering").slice(0, 8),
  ),
  "douro-dalen-subregioner": hedvinBlock(
    ["douro-dalen-subregioner"],
    "Portvin & Douro",
    "Subregioner bag portvin — plus typer, husvalg og Portugal.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "douro-dalen-subregioner").slice(0, 6),
    HEDVIN_VIDEN,
  ),
  "sadan-serverer-du-portvin": hedvinBlock(
    ["sadan-serverer-du-portvin"],
    "Portvin-klyngen",
    "Servering, temperatur og glas — plus typer og holdbarhed.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "sadan-serverer-du-portvin").slice(0, 8),
  ),
  "hvor-laenge-holder-portvin": hedvinBlock(
    ["hvor-laenge-holder-portvin"],
    "Portvin-klyngen",
    "Holdbarhed åbnet og uåbnet — plus servering og typer.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "hvor-laenge-holder-portvin").slice(0, 8),
  ),
  "portvin-alkoholprocent": hedvinBlock(
    ["portvin-alkoholprocent"],
    "Portvin-klyngen",
    "Alkohol i port — plus typer, servering og hedvin-overblik.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "portvin-alkoholprocent").slice(0, 8),
  ),
  "portvin-til-ost": hedvinBlock(
    ["portvin-til-ost"],
    "Portvin-klyngen",
    "Port til ost — plus chokolade, risalamande og typer.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "portvin-til-ost").slice(0, 8),
  ),
  "portvin-til-chokolade": hedvinBlock(
    ["portvin-til-chokolade"],
    "Portvin-klyngen",
    "Port til chokolade — plus ost, risalamande og typer.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "portvin-til-chokolade").slice(0, 8),
  ),
  "portvin-til-risalamande": hedvinBlock(
    ["portvin-til-risalamande"],
    "Portvin-klyngen",
    "Port til risalamande — LBV, tawny, Vintage og julekontekst.",
    [HEDVIN_PILLAR],
    [{ slug: "hvad-er-portvin", label: "Hvad er portvin?" }],
    HEDVIN_PORT.filter((l) => l.slug !== "portvin-til-risalamande").slice(0, 8),
  ),
