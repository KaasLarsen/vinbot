...
export const GUIDE_CLUSTER_LINKS: Record<string, GuideClusterBlock | GuideClusterBlock[]> = {
  ...
  "chillable-reds": videnBlock(
    ...
    [VIN_VIDEN_PILLAR],
    [
      { slug: "chill-your-reds", label: "Chill Your Reds (ultimativ guide)" },
      { slug: "afkoelt-roedvin", label: "Afkølet rødvin (fuld guide)" },
      { slug: "20-minutter-i-koeleskabet-roedvin", label: "20 minutter i køleskabet" },
  ...
  "chill-your-reds": videnBlock(
    ["chill-your-reds"],
    "Chill Your Reds",
    "Videnskab, °C og mad til afkølede lette rødvine.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "chillable-reds", label: "Hvad er chillable reds?" },
      { slug: "afkoelt-roedvin", label: "Afkølet rødvin" },
      { slug: "20-minutter-i-koeleskabet-roedvin", label: "20 minutter i køleskabet" },
      { slug: "top-5-druer-til-koeleskabet", label: "Top 5 druer til køleskabet" },
      { slug: "rodvin-til-fisk-kold", label: "Rødvin til fisk (kold)" },
  ...
  "20-minutter-i-koeleskabet-roedvin": videnBlock(
    ["20-minutter-i-koeleskabet-roedvin"],
    "20 minutter i køleskabet",
    "Lifehacket der redder lun rødvin på en varm dag.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "chill-your-reds", label: "Chill Your Reds" },
      { slug: "afkoelt-roedvin", label: "Afkølet rødvin" },
      { slug: "hurtig-koeling-vin-is-salt-10-minutter", label: "Hurtig-køling med is og salt" },
      { slug: "isspand-og-flaskekoeler-vin", label: "Isspand og flaskekøler" },
    ],
  ),
  "top-5-druer-til-koeleskabet": videnBlock(
    ["top-5-druer-til-koeleskabet"],
    "Top 5 druer til køleskabet",
    "Gamay, Frappato, Pinot, Barbera og Valpolicella.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "chill-your-reds", label: "Chill Your Reds" },
      { slug: "gamay-druen", label: "Gamay-druen" },
      { slug: "pinot-noir-druen", label: "Pinot noir-druen" },
      { slug: "barbera-druen", label: "Barbera-druen" },
      { slug: "rodvin-til-fisk-kold", label: "Rødvin til fisk (kold)" },
    ],
  ),
  "rodvin-til-fisk-kold": videnBlock(
    ["rodvin-til-fisk-kold"],
    "Rødvin til fisk (kold)",
    "Når afkølet let rød udfordrer hvidvin til fed fisk.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "chill-your-reds", label: "Chill Your Reds" },
      { slug: "vin-til-fisk-og-skaldyr", label: "Vin til fisk og skaldyr" },
  ...
  "rodvin-til-terrassen": videnBlock(
    ["rodvin-til-terrassen"],
    "Rødvin til terrassen",
    "Kold let rød som aperitif i solen — alternativ til rosé.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "chill-your-reds", label: "Chill Your Reds" },
      { slug: "vin-til-sommer", label: "Vin til sommer" },
      { slug: "rosevin-til-mad-og-sommer", label: "Rosé til mad og sommer" },
      { slug: "20-minutter-i-koeleskabet-roedvin", label: "20 minutter i køleskabet" },
    ],
  ),
  "farvel-sancerre-goddag-assyrtiko": videnBlock(
    ["farvel-sancerre-goddag-assyrtiko"],
    "Farvel Sancerre, goddag Assyrtiko",
    "Græsk mineralitet og syre som value-alternativ til Loire.",
    [VIN_VIDEN_PILLAR],
    [
  ...
  "vinho-verde-vs-alvarinho": videnBlock(
    ["vinho-verde-vs-alvarinho"],
    "Vinho Verde vs. Alvarinho",
    "Nordportugals to store hvidstile — forskel og madmatch.",
    [VIN_VIDEN_PILLAR],
    [
      ...
      { slug: "xinomavro-og-touriga-nacional", label: "Xinomavro og Touriga Nacional" },
    ],
  ),
  "xinomavro-og-touriga-nacional": videnBlock(
    ["xinomavro-og-touriga-nacional"],
    "Xinomavro og Touriga Nacional",
    "Glemte røde value-druer fra Grækenland og Portugal.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "touriga-nacional-druen", label: "Touriga nacional-druen" },
      { slug: "vinregion-portugal", label: "Vinregion Portugal" },
      { slug: "vin-til-graesk-mad", label: "Vin til græsk mad" },
      { slug: "farvel-sancerre-goddag-assyrtiko", label: "Assyrtiko (hvid value)" },
    ],
  ),
  "graesk-meze-braet": videnBlock(
    ["graesk-meze-braet"],
    "Græsk meze-bræt",
    "Sådan sammensætter du oliven, tzatziki, feta og græsk hvidvin.",
    [VIN_VIDEN_PILLAR],
    [
      { slug: "vin-til-graesk-mad", label: "Vin til græsk mad" },
      { slug: "farvel-sancerre-goddag-assyrtiko", label: "Farvel Sancerre, goddag Assyrtiko" },
