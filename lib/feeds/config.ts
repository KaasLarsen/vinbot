...
/** Forsigtigt frasorteret ikke-vins glas og smykker i blandfeeds. */
const VIN_ADJ_EXCLUDE_NON_WINE_GLASS: string[] = [
  "ørering",
  "smykker",
  "armbånd",
  "halskæde",
...
export const FEEDS: FeedConfig[] = [
  ...
  { merchant: "Lauridsen Vine", url: "https://www.partner-ads.com/dk/feed_udlaes.php?partnerid=50537&bannerid=116085&feedid=4230" },
  {
    ...
    wineFilter: false,
    vinAdjacentIncludeAny: [...VIN_ADJ_GLASS_AND_TOOLS, "matrivo glas"],
    vinAdjacentExcludeAny: [...VIN_ADJ_EXCLUDE_NON_WINE_GLASS],
  },
  {
    merchant: "Likehome.dk",
    url: "https://www.partner-ads.com/dk/feed_udlaes.php?partnerid=50537&bannerid=64634&feedid=1274",
    wineFilter: false,
  ...
  {
    merchant: "8wines",
    url: "https://daisycon.io/datafeed/?media_id=399526&standard_id=4&language_code=da&locale_id=11&type=xml&program_id=19317&html_transform=none&rawdata=false&encoding=utf8&general=false",
  },
  {
    merchant: "Wine Store",
