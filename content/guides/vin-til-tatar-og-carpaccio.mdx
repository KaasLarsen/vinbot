...
## Vin til tatar vs. carpaccio — kort svar

| Ret | Bedste vin | Temperatur |
|-----|------------|------------|
| **Bøftatar** (hakket, æggeblomme) | Gamay, pinot noir, beaujolais | 13–14 °C |
| **Carpaccio** (tynde skiver, parmesan) | Rosé, champagne, alsace pinot | 10–12 °C |
| Begge med citron/capers | Syre og lav tannin — undgå cabernet | — |

## Vin til carpaccio — hurtig guide

Søger du **vin til carpaccio** specifikt (uden tatar)? Gå endnu lettere end til tatar:

- **Rosé** med syre (Provence, tør italiensk rosato) ved 10–12 °C.
- **Champagne brut** eller **crémant** — citron og parmesan.
- **Alsace pinot noir** eller **jura trousseau** — delikat rød.

Carpaccio er **tyndere og mere delikat** end tatar — undgå alt med hård tannin.
