...
hub: vin-viden
---
## Tegn på dårlig vin — hurtig tabel

| Fejl | Lugt / smag | Farlig? |
|------|-------------|---------|
| **Korksmag (TCA)** | Våd hund, muggen kælder | Nej — kassér |
| **Oxidation** | Sherry-agtig, brun farve | Nej — kassér |
| **Eddike (VA)** | Neglelakfjerner, stikkende | Nej — kassér |
| **Flad / død** | Ingen frugt, kedelig | Nej — madlavning OK |
