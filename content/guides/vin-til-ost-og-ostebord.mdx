---
title: 'Vin til ost og ostebord: port, sherry, bobler og rødvin'
description: >-
  Vin til ostebord og danske oste: bobler og syrlig hvid til milde oste, sherry
  og fadlagret hvid til lagrede oste, port og sauternes til blåskimmel. Undgå…
...
## Hvilken vin til ost? — kort svar

| Ostetype | Bedste vin |
|----------|------------|
| **Mild (brie, havarti)** | Bobler, sauvignon, chablis |
| **Lagret hård (comté, parmesan)** | Amontillado sherry, moden chardonnay |
| **Blåskimmel (danablu, roquefort)** | Port, Sauternes, sød vin |
| **Gedeost** | Sancerre, sauvignon, let rød |

Tre flasker dækker et dansk ostebord: **bobler + sherry + port**. Kun **én flaske**? Se [vin til hele ostebordet](/guides/vin-til-hele-ostebordet). Danske navne: [Gammel Knas](/guides/vin-til-gammel-knas), [Vesterhavsost](/guides/vin-til-vesterhavsost). Se også [blåskimmel](/guides/vin-til-blaaskimmelost) og [hård ost](/guides/vin-til-hard-ost).
...
## Vin til ostebord i Danmark — praktisk menu

Dansk **ostebord** og **julefrokost** byder på **Danbo, havarti, brie, blåskimmel og gamle hårde oste** — ofte sammen med **sild, leverpostej og rugbrød**. Tre flasker dækker brættet:

1. **Bobler eller tør hvid** (brut champagne, cava, sauvignon) — til mild ost og start.
2. **Amontillado / oloroso sherry** eller moden chardonnay — til lagrede oste.
3. **Port eller Sauternes** — til blåskimmel og kraftig ost.

Se også [vin til blåskimmelost](/guides/vin-til-blaaskimmelost) og [vin til hard ost](/guides/vin-til-hard-ost).

<PriceRunnerProduct productKey="grahams-10-tawny" heading="Tawny port til ostebord — Graham's 10 år" />

## Vin til ost og ostebord — den klassiske udfordring
...
**Port nævnes ofte som "osten ven"** — men det er især **vintage og LBV port** til **stilton og kraftig blåskimmel** der er klassisk. **Tawny port (10-20 år)** er bedre til **hård lagret ost og nøddedesserter**. Dedikeret dybde: [portvin til ost](/guides/portvin-til-ost). Men lad ikke port være default — **Sauternes slår port til roquefort** i mange blindtests.
...
4. **[Vesterhavsost](/guides/vin-til-vesterhavsost)** (hård dansk): rioja reserva, amontillado.
5. **Danablu (blåskimmel):** port, Sauternes, Tokaji.
6. **[Gammel Knas](/guides/vin-til-gammel-knas)** / **Havgus** (lagret dansk): tawny, vintage port, oloroso.

Oste fra **Netto, Rema og Coop**: [vin til supermarkedets ostebord](/guides/vin-til-supermarkedets-ostebord). Rød der smagte grimt: [hvorfor smager rødvin grimt til ost](/guides/hvorfor-smager-rodvin-grimt-til-ost).

Strategi: 1 flaske cava eller champagne (til første tre oste) + 1 flaske LBV port eller Sauternes (til blåskimmel og hård) — eller [én kompromis-flaske](/guides/vin-til-hele-ostebordet).
