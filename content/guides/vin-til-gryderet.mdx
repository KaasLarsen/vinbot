...
description: "Hvilken vin til gryderet og braising — og vin til morkelsovs og kantarelsovs på tallerkenen? Grenache/syrah, rioja, gamay og pinot med moden frugt."
...
**Gryderet** (braiseret kød) er en af de mest trøstende og dybe retstyper der findes. Langsom, lang simring ved lav varme i fond, rødvin, tomat eller øl opbryder de bindevæv og kollagen i kødet, og resultatet er **fløjlsblødt kød** og en **koncentreret, sødlig sovs**. Klassikerne spænder bredt: **[boeuf bourguignon](/opskrifter/boeuf-bourguignon)** (fransk okse i rødvin), **[coq au vin](/opskrifter/coq-au-vin)** (kylling i rødvin), **osso buco** (italiensk kalveskank), **goulash** (ungarsk paprika-gryderet), **tagine** (marokkansk simret), **carbonnade flamande** (belgisk okse i øl), **oksekødsgryderet** (dansk klassiker). Flere opskrifter med vin i gryden: [braiseret lammeskank](/opskrifter/braiseret-lammeskank-med-rodvin), [oksekaebe](/opskrifter/braiseret-oksekaebe-med-rodvin) og [svinekæber i rødvinssky](/opskrifter/svinekaebber-i-rodvinssky).
...
- Dedikeret guide: [vin til skipperlabskovs](/guides/vin-til-skipperlabskovs). Til **gule ærter**: [vin til gule ærter](/guides/vin-til-gule-aerter). Til **braiseret okseskank**: [vin til okseskank](/guides/vin-til-okseskank).
...
Er saucen **meget sød** (reduktion, port el.l.), undgå **knastør rød uden moden frugt**. **Vin i gryden** efter stegte svampe (deglasering, port-nip): [sådan bruger du vin til sauce og simren](/guides/sadan-bruger-du-vin-til-sauce-og-simren) og [bedste portvin](/guides/bedste-portvin).
...
[Sådan bruger du vin til sauce og simren](/guides/sadan-bruger-du-vin-til-sauce-og-simren) · [vin til lam](/guides/vin-til-lam) · [vin til lasagne](/guides/vin-til-lasagne) · [vin til oksekød](/guides/vin-til-oksekoed) · [vin til bøf](/guides/vin-til-boeff) · [vin til oksekød i sauce](/guides/vin-til-oksekoed-i-sauce) · [vin til gulasch](/guides/vin-til-gulasch) · [komplet guide til vin og mad](/guides/komplet-guide-til-vin-og-mad)
