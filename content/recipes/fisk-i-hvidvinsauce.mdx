...
## Beurre blanc-princippet i praksis

Selv om dette ikke er klassisk beurre blanc, følger saucen samme logik: reducer vin, pocher fisken blidt, montér med koldt smør fra varmen. Smørret emulgerer og giver glans uden tung fløde. Et nip mousserende vin tilføjer ekstra friskhed — teknikken kendes fra mange franske hjemmekøkkener og passer til torsk, kuller og pighvar.

## Fiskens tykkelse og pocheringstid

Tynde fileter tager seks minutter ved lav simren; tykkere torsk kan tage op til ti. Fisken er færdig når kødet flager let med en gaffel — ikke når den falder fra hinanden. Hav tilbehør klar inden fisken går i panden; den falder hurtigt i temperatur ved bordet. Asparges eller spinat kan dampes i samme sauce de sidste minutter for en samlet tallerken.
