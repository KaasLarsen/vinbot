#!/usr/bin/env node
/** Top 30 vinretter batch 2: 5 nye klassikere + guide-recipe-links + FAQ.
...
import {
  ...
  SLUG_EXPANSIONS,
  UPDATED,
} from "./recipes-top30-batch2-data.mjs";
