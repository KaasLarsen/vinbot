...
const PAGE_DESCRIPTION =
  "134+ opskrifter hvor vin er en del af retten: boeuf bourguignon, chimichurri, hummus, caldeirada, cassoulet, æbletærte med calvados, svinekæber i rødvinssky, chorizo al vino, estofado, risotto al Barolo, torsk i hvidvin, sauerbraten, stegt flæsk og mere. Filtrér efter rød/hvidvin, køkken og tid.";
