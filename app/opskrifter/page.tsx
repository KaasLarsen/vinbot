...
const PAGE_DESCRIPTION =
  "48+ opskrifter hvor vin er en del af retten: coq au vin, chorizo al vino, estofado, risotto al Barolo, torsk i hvidvin, sauerbraten, stegt flæsk og mere. Filtrér efter rød/hvidvin, køkken og tid.";
