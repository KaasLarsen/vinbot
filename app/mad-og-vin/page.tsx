    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <section className="mt-10 rounded-2xl border border-emerald-200 bg-emerald-50/60 p-6">
        ...
        <div className="mt-4 grid gap-x-6 gap-y-2 text-sm text-rose-900 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Link href="/opskrifter/flaesketesteg-med-rodvin-i-brun-sovs" className="hover:underline">
            Flæskesteg med rødvin i brun sovs
          </Link>
          <Link href="/opskrifter/frikadeller-i-hvidvinsauce" className="hover:underline">
            Frikadeller i hvidvinsauce
          </Link>
          <Link href="/opskrifter/andesteg-med-port-og-hvidvin" className="hover:underline">
            Andesteg med port og hvidvin
          </Link>
          <Link href="/opskrifter/ossobuco-med-hvidvin" className="hover:underline">
            Ossobuco med hvidvin
          </Link>
          <Link href="/opskrifter/paella-med-hvidvin" className="hover:underline">
            Paella med hvidvin
          </Link>
          <Link href="/opskrifter/chili-con-carne-med-rodvin" className="hover:underline">
            Chili con carne med rødvin
          </Link>
          <Link href="/opskrifter/muslinger-i-hvidvin" className="hover:underline">
            Muslinger i hvidvin
          </Link>
          <Link href="/opskrifter/kalv-i-hvidvinsauce" className="hover:underline">
            Kalv i hvidvinsauce
          </Link>
          ...
          <Link href="/opskrifter/hakkeboef-i-rodvinssauce" className="hover:underline">
            Hakkebøf i rødvinssauce
          </Link>
          <Link href="/opskrifter/ragu-med-rodvin" className="hover:underline">
            Ragù med rødvin
          </Link>
      ...
      <section className="mt-10 rounded-2xl border border-rose-200 bg-rose-50/60 p-6">
        ...
        <div className="mt-4 grid gap-x-6 gap-y-2 text-sm text-rose-900 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Link href="/guides/vin-til-asiatisk-mad" className="hover:underline">Asiatisk mad (oversigt)</Link>
          ...
          <Link href="/guides/bedste-bobler-under-100-kr" className="hover:underline">Bedste bobler under 100 kr</Link>
